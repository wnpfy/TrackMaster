...
#include "TrackMasterSportsCar.h"
#include "TrackMasterSportsWheelFront.h"
#include "TrackMasterSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ATrackMasterSportsCar::ATrackMasterSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTrackMasterSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTrackMasterSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTrackMasterSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTrackMasterSportsWheelRear::StaticClass();

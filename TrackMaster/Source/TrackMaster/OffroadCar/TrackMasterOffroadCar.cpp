...
#include "TrackMasterOffroadCar.h"
#include "TrackMasterOffroadWheelFront.h"
#include "TrackMasterOffroadWheelRear.h"
...
ATrackMasterOffroadCar::ATrackMasterOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UTrackMasterOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UTrackMasterOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UTrackMasterOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UTrackMasterOffroadWheelRear::StaticClass();

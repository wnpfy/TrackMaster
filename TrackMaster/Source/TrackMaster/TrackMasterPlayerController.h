...
#include "TrackMasterPlayerController.generated.h"

class UInputMappingContext;
class ATrackMasterPawn;
class UTrackMasterUI;
 ...
 */
UCLASS(abstract)
class ATrackMasterPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<ATrackMasterPawn> VehiclePawnClass;

	/** Pointer to the controlled vehicle pawn */
	TObjectPtr<ATrackMasterPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, Category="Vehicle|UI")
	TSubclassOf<UTrackMasterUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UTrackMasterUI> VehicleUI;
